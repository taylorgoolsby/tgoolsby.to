...
export default class Config {
  ...
  static previewImage: string =
    'https://s3.us-east-2.amazonaws.com/tgoolsby.to/preview.jpg'

  static siteName: string = 'tgoolsby.to'
  static siteUrl: string = 'https://tgoolsby.to'
  static siteDescription: string = 'Taylor Goolsby'
}
